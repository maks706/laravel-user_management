    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-lock'></i> Қауіпсіздік
            </h1>
                ...
                <div class="col-xl-6">
                    <div id="panel-1" class="panel">
                        <div class="panel-container">
                            <div class="panel-hdr">
                                <h2>эл. адрес және құпия сөзді жаңарту</h2>
                            </div>
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Құпия сөзді растау</label>
                                    <input type="password" id="simpleinput" class="form-control" name="newPassword2">
                                </div>


                                <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                                    <button class="btn btn-warning">Өзгерту</button>
                                </div>
                            </div>
                        </div>
