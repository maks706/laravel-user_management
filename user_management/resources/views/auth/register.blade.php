                                ...
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    @csrf
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" id="emailverify" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}">
                                            @if ($errors->has('email'))
                                                <span class="invalid-feedback" role="alert">
                                                <strong>
                                                     @foreach($errors->all('email') as $error)
                                                        {{$error}}<br>
                                                     @endforeach      
                                                </strong>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if ($errors->has('password'))
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>@foreach($errors->all('password') as $error)
                                                                {{$error}}<br>
                                                            @endforeach
                                                    </strong>
                                                </span>
